...
/// <summary>
/// A snapshot of what a presenter has done since it was created or last reset.
/// </summary>
/// <remarks>
...
/// </remarks>
public readonly struct VideoCompositionStatistics
{
    ...
    public VideoCompositionStatistics(
        long framesComposed,
        long framesDrawn,
